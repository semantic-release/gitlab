        ...
        if (_url) {
          ...
          if (target === "generic_package") {
            ...
            uploadEndpoint = urlJoin(
              projectApiUrl,
              `packages/generic/${encodedChannel}/${encodedVersion}/${encodedLabel}?${
            ...
            const url = urlJoin(projectApiUrl, `packages/generic/${encodedChannel}/${encodedVersion}/${encodedLabel}`);
